...
class LZ77MultiChoiceCoder:
    ...
    def start_encoding_get_capacity(self, data) -> int:
        ...
        while cursor < len(data):
            ...
            if num_of_choices > 1:
                ...
                self._ns_coder.limits.append(num_of_choices)
        ...
        side_channel_capacity = int(math.floor(side_channel_capacity))
        return side_channel_capacity
    ...
    def decode(data_enc) -> (str, str):
        ...
        hidden_data_bits = ns_decoder.sequence_to_bits(np.array(distance_choices))
        return data_dec, hidden_data_bits
...
if __name__ == '__main__':
    alphabet = ['A', 'B']
    msg1 = random_msg(alphabet, 5000)
    lz_coder = LZ77MultiChoiceCoder()
    msg1_n_hidden_bits = lz_coder.start_encoding_get_capacity(msg1)
    print("Hidden channel capacity:", msg1_n_hidden_bits)
    hidden_msg1 = "0101101000100001001110000"
